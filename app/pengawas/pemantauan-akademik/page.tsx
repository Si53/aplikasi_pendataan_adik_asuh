...
import {
  PengawasAkademikView,
  type StudentAcademicProfile,
} from "@/components/pengawas-akademik-view"

export default async function PemantauanAkademikPage() {
  ...
  // Format presigned URLs untuk berkas rapor pada setiap update akademik siswa
  const students: StudentAcademicProfile[] = await Promise.all(
    rawStudents.map(async (s) => {
      const updates = await Promise.all(
        s.academicUpdates.map(async (u) => {
      ...
      return {
        ...
        nilaiAwal: s.nilaiRataRata,
        wilayah: s.wilayah,
        isBinaan: s.pengawasId === pengawas.id,
        academicUpdates: updates,
      }
    })
  )
  ...
  return (
    <div className="relative min-h-dvh w-full">
          ...
          <defs>
            ...
            >
              ...
              <g transform="translate(30, 30)">
                ...
                <line x1="0" y1="-14" x2="0" y2="14" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
                <line x1="-14" y1="0" x2="14" y2="0" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" />
      ...
      <main className="mx-auto flex min-h-dvh w-full max-w-4xl flex-col gap-6 px-4 py-6 sm:px-6 sm:py-8">
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-1.5">
                <Link
                  href="/pengawas"
                  className="text-lg sm:text-xl font-extrabold text-orange-600 tracking-tight hover:underline"
                >
                  Pemantauan Akademik
                </Link>
              </div>
        ...
        {/* PEMANTAUAN AKADEMIK VIEW (READ-ONLY) */}
        <PengawasAkademikView
          students={students}
